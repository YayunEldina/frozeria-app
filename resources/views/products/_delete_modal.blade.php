{{-- resources/views/products/_delete_modal.blade.php --}}
<div 
        ...
        >
            <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <h3 class="text-lg leading-6 font-bold text-gray-900">Hapus barang?</h3>
                    <div class="mt-2">
                        <p class="text-sm text-gray-500 leading-relaxed">
                            Data <span class="font-bold text-gray-900" x-text="productName"></span> akan dihapus secara permanen dari sistem. Tindakan ini tidak daapat dibatalkan.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-8 flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-3">
                <button 
                    @click="open = false" 
                    type="button" 
                    class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 px-4 py-2 bg-white text-gray-700 hover:bg-gray-50 sm:mt-0 sm:w-auto sm:text-sm"
                >
                    Batal
                </button>
                ...
                <form :action="'/products/' + productId" method="POST" class="inline">
                    ...
                    <button 
                        type="submit" 
                        class="w-full inline-flex justify-center rounded-md border border-red-300 px-4 py-2 bg-white text-red-700 hover:bg-red-50 sm:w-auto sm:text-sm"
                    >
                        Ya, Hapus
                    </button>
                </form>
